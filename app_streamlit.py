...
with st.sidebar:
    st.header("О модели")
    st.markdown("**Модель:** `mT5-small (LoRA Fine-tuned)`")
    st.markdown("**Параметры:** ~300М (эффективных обучаемых: 0.16%)")
    st.markdown("**Архитектура:** mT5-small + LoRA адаптеры")
    st.markdown("**Обучена на:** 20,000+ статей датасета Gazeta")
